...
class Brand extends CoreModel {
    ...
    public static function delete($brandId)
    {
        ...
        // on demande à PDO de se préparer à exécuter cette requete
        // PDO prepare retourne un objet PdoStatement
        $pdoStatement = $pdo->prepare($sql);

        $pdoStatement->bindValue(':id', $brandId, PDO::PARAM_INT);

        // on exécute la requete en spécifiant des valeurs pour nos paramètres
